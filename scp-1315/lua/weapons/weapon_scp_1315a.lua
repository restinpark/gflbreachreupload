...
--------------------------------]]
local config = {}
config.SWEPName = "SCP-1315"
SWEP.droppable = false
SWEP.Author = "Cat and Demonkush / modified by chan_man1"
config.ActionDelay = 10 -- Time in between each action.
--[[-------------------------------------------------------------------------
Phantom Force
---------------------------------------------------------------------------]]
config.PhantomForceDelay = 10 -- How long until you can use it again after attack?
config.PhantomForceDuration = 5 -- How long can you use this for?
config.PhantomForceRadius = 90 -- Radius around the player shadow to deal damage?
config.PhantomForceDamageLow = 55
config.PhantomForceDamageHigh = 88

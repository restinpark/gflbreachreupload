...
SWEP.PrintName				= "Karabiner 98k"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_K98.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_K98.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_k98.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_k98.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-4.275, -5.0, 0.85)
SWEP.IronSightsAng = Vector(0.2, 0, 0)

SWEP.SightsPos = SWEP.IronSightsPos
SWEP.SightsAng = SWEP.IronSightsAng

SWEP.IronSightsPos_Kobra = Vector(-4.275, -10, -1.265)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech =  Vector(-4.275, -10, -1.554)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-4.275, -10, -1.629)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-4.272, -11, -1.633)
SWEP.IronSightsAng_2XRDS = Vector(0, 0.00, 0)

SWEP.IronSightsPos_C79 = Vector(-4.275, -8, -2.057)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-4.185, -9, -1.4)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0)

SWEP.IronSightsPos_Mosin = Vector(-4.247, -11, -1.097)
SWEP.IronSightsAng_Mosin = Vector(0, 0, 0)

SWEP.IronSightsPos_MX4 = Vector(-4.289, -10, -1.407)

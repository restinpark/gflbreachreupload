...
SWEP.Base                   = "exp_bow"
SWEP.Category                = "Compound Bow"
SWEP.PrintName                 = "SCP-154"
SWEP.HoldType                 = "rpg"
SWEP.Slot = 3
SWEP.SlotPos = 2

SWEP.Author            = "AlliedForces"
...
SWEP.WElements = {
	["w_model"] = { type = "Model", model = "models/weapons/w_snip_scoub.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.909, 0, 0), angle = Angle(-15.341, -1.024, 30), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}



function SWEP:PrimaryAttack()
	if self.Owner:Health() > 20 then
	if self:CanPrimaryAttack() then
		...
		timer.Simple(10, function() self.Owner:SetHealth(self.Owner:Health() + 10) end )
		end
	end
end

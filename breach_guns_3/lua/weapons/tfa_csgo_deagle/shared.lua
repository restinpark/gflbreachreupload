...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_DEAGLE.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 266.67					-- This is in Rounds Per Minute / RPM
...
SWEP.Primary.SpreadMultiplierMax = 7.5 --How far the spread can expand when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_pist_deagle.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_csgo/w_deagle.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.735, 0, 0.35)
SWEP.IronSightsAng = Vector(0.6, 0.325, 0)
...
SWEP.ShellParticleName = "weapon_shell_casing_9mm_fallback"

--[[EVENT TABLE]]--

SWEP.MagModel = Model("models/weapons/tfa_csgo/w_pist_deagle_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ time = 15 / 30, type = "lua", value = function(wep,vm) wep:DropMag() end, client = true, server = true }
	}

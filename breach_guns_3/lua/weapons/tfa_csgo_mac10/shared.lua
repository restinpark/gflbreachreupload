SWEP.Gun					= ("tfa_csgo_mac10") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_MAC10.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_smg_mac10.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-6.115, -4, 2.275)
SWEP.IronSightsAng = Vector(-0.53, 0.122, -0.968)
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_smg_mac10_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ time = 25 / 30, type = "lua", value = function(wep,vm) wep:DropMag() end, client = true, server = true },
	}

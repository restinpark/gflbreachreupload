SWEP.Gun					= ("tfa_csgo_galil") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_GALIL.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 666.67					-- This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_rif_galilar.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-5.318, -4, 1.665)
SWEP.IronSightsAng = Vector(-0.18, 0.01, 0)
...
SWEP.BlowbackVector = Vector(0,-1.0,0.05) --Vector to move bone <or root> relative to bone <or view> orientation.
SWEP.BlowbackCurrentRoot = 0 --Amount of blowback currently, for root
SWEP.BlowbackCurrent = 0 --Amount of blowback currently, for bones
SWEP.BlowbackBoneMods = {
	["v_weapon.bolt"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -6), angle = Angle(0, 0, 0) },
	["v_weapon.plate"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.333, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_rif_galil_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ time = 23 / 30, type = "lua", value = function(wep,vm) wep:DropMag() end, client = true, server = true },
	}

SWEP.Gun					= ("tfa_csgo_m4a4") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_M4A4.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_rif_m4a1.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_csgo/w_m4a4.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-5.189, -4, 0.895)
SWEP.IronSightsAng = Vector(-0.285, -0.175, -2.112)
...
--[[EVENT TABLE]]--
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_rif_m4a4_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {

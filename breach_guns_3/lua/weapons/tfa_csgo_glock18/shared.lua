SWEP.Gun					= ("tfa_csgo_glock18") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_GLOCK18.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_pist_glock18.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-2.828, 0, 1.248)
SWEP.IronSightsAng = Vector(0.64, -0.06, 0)
...
SWEP.BlowbackBoneMods = {
	["v_weapon.glock_slide"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -1.225), angle = Angle(0, 0, 0) },
}
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_pist_glock18_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {

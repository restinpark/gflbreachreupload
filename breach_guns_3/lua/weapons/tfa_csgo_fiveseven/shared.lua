SWEP.Gun					= ("tfa_csgo_fiveseven") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_FIVESEVEN.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_pist_fiveseven.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-2.71, 0, 0.775)
SWEP.IronSightsAng = Vector(0.4, 0.3, 0)
...
SWEP.BlowbackBoneMods = {
	["v_weapon.fiveSeven_slide"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -1.5), angle = Angle(0, 0, 0) }
}
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_pist_fiveseven_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {

...
SWEP.PrintName				= "USP-S"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_USP.2")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("TFA_CSGO_USP.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 352.94					-- This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_pist_223.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_csgo/w_usp.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.84, 0, 1.585)
SWEP.IronSightsAng = Vector(-0.703, -0.018, 0)
...
SWEP.BlowbackBoneMods = {
	["v_weapon.Slide"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -1.675), angle = Angle(0, 0, 0) }
}
...
SWEP.MuzzleAttachmentSilenced	= "muzzle_flash2"
...
SWEP.MuzzleFlashEffectSilenced = "tfa_csgo_muzzle_pistol_silenced"
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_pist_usp_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_DETACH_SILENCER] = {
		{ time = 0, type = "lua", value = function(wep, vm) wep.Bodygroups_V["silencer"] = 0 end },
	},
	[ACT_VM_ATTACH_SILENCER] = {
		{ time = 5 / 30, type = "lua", value = function(wep, vm) wep.Bodygroups_V["silencer"] = 0 end },
	},
	[ACT_VM_RELOAD] = {
		{ time = 16 / 30, type = "lua", value = function(wep,vm) wep:DropMag() end},
	}
}
...
function SWEP:Think2()
	...
	if self:GetStatus() ~= TFA.Enum.STATUS_SILENCER_TOGGLE then
		silenced = self:GetSilenced()

		self.Bodygroups_V["silencer"] = silenced and 0 or 1
		self.Bodygroups_W["silencer"] = silenced and 0 or 1
	end
end
SWEP.Gun					= ("tfa_csgo_p2000") --Make sure this is unique.  Specically, your folder name.  
...
SWEP.PrintName				= "P2000"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_P2000.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_pist_hkp2000.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-2.815, 0, 0.95)
SWEP.IronSightsAng = Vector(0.54, -0.007, 0)
...
SWEP.BlowbackBoneMods = {
	["v_weapon.HKP2000_Slide"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -1.25), angle = Angle(0, 0, 0) }
}
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_pist_p2000_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ time = 17 / 30, type = "lua", value = function(wep,vm) wep:DropMag() end, client = true, server = true },
	}
...
SWEP.VElements = {
	["nametag"] = { type = "Model", model = "models/weapons/tfa_csgo/uid_small.mdl", bone = "v_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, bodygroup = {}, active = true }
}
SWEP.Gun					= ("nope_sylveon_swep") --Make sure this is unique.  Specically, your folder name.  
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "tfa_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "TFA Pokemon" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep.
SWEP.Author				= "Nopeful" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "" --Purpose Tooltip
SWEP.Instructions				= "Sylveon." --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.PrintName				= "Sylveon"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("NOPE_SYLVEON.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/sylveon/v_sylveon_nope.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/rtbmodels/pokemonxy/sylveon.mdl" -- Worldmodel path
...
SWEP.RunSightsPos = Vector(7.747, 0.419, -3.07)
SWEP.RunSightsAng = Vector(-10.542, 35.553, -8.195)
...
SWEP.InspectPos = Vector(6, 4, 0) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(5, 20, 0) --Replace with a vector, in style of ironsights angle, to be used for inspection

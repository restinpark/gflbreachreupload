...
SWEP.Gun = ("tfa_csgo_sawedoff")					-- must be the name of your swep
...
SWEP.ViewModel				= "models/weapons/tfa_csgo/c_shot_sawedoff.mdl"	-- Weapon view model
...
SWEP.Primary.Sound			= Sound("TFA_CSGO_SAWEDOFF.1")		-- Script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-4.3, -4, 1.875)
SWEP.IronSightsAng = Vector(0.548, 0.025, 0.45)
...
SWEP.IronSightsMoveSpeed  = 210/260*0.8 --Multiply the player's movespeed by this when sighting.

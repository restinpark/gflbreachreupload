SWEP.Gun					= ("tfa_csgo_famas") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_FAMAS.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Burst				= 800					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_rif_famas.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-6.275, -4, 1.35)
SWEP.IronSightsAng = Vector(-0.45, -0.165, -2.25)
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_rif_famas_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ time = 24 / 27, type = "lua", value = function(wep,vm) wep:DropMag() end, client = true, server = true },
	}

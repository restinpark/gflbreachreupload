...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_AK47.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_rif_ak47.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_csgo/w_ak47.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-4.980, -4, 0.821)
SWEP.IronSightsAng = Vector(1.115, 0.134, -2)
...
SWEP.BlowbackBoneMods = {
	["v_weapon.AK47_bolt"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -3.922), angle = Angle(0, 0, 0) }
}
...
SWEP.MuzzleFlashEffect = "tfa_csgo_muzzle_assaultrifle" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_rif_ak47_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ time = 22 / 30, type = "lua", value = function(wep,vm) wep:DropMag() end, client = true, server = true }
	}

SWEP.Gun					= ("tfa_csgo_bizon") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_BIZON.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_smg_bizon.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-5.092, -4, 0.765)
SWEP.IronSightsAng = Vector(0.72, 0.005, 0)
...
SWEP.BlowbackVector = Vector(0,-2,0.01) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_smg_bizon_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {

SWEP.Gun					= ("tfa_csgo_p250") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_P250.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_pist_p250.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-2.7, 0, 0.66)
SWEP.IronSightsAng = Vector(0.975, 0.325, 0.45)
...
SWEP.BlowbackBoneMods = {
	["v_weapon.p250_slide"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -1.25), angle = Angle(0, 0, 0) },
	["v_weapon.p250_hammer"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, -65) }
}
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_pist_p250_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {

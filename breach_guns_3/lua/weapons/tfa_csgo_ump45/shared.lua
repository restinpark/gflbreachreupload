SWEP.Gun					= ("tfa_csgo_ump45") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_UMP45.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 500.14					-- This is in Rounds Per Minute / RPM
...
SWEP.Primary.Spread		= .0060					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_smg_ump45.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-5.11, -4, 0.9)
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_smg_ump45_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {

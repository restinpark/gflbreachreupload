SWEP.Gun					= ("tfa_csgo_mp9") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_MP9.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 857.14					-- This is in Rounds Per Minute / RPM
...
SWEP.MoveSpeed = 240/260 --Multiply the player's movespeed by this.
SWEP.IronSightsMoveSpeed  = 240/260*0.8 --Multiply the player's movespeed by this when sighting.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_smg_mp9.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_csgo/w_mp9.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-4.725, -4, 0.765)
SWEP.IronSightsAng = Vector(0.635, 0.125, -1)
...
SWEP.BlowbackVector = Vector(0,-1.25,0.01) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.TracerParticleName = "weapon_tracers_smg"
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_smg_mp9_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {

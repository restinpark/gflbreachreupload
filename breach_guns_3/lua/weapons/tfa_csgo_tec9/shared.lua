SWEP.Gun					= ("tfa_csgo_tec9") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_TEC9.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_pist_tec9.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_csgo/w_tec9.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-5.08, 0, 2.76)
SWEP.IronSightsAng = Vector(-0.496, 0.139, -1.2)
...
SWEP.BlowbackBoneMods = {
	["v_weapon.Slide"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -3.5), angle = Angle(0, 0, 0) }
}
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_pist_tec9_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {

SWEP.Gun					= ("tfa_csgo_scar20") --Make sure this is unique.  Specically, your folder name.  
...
SWEP.PrintName				= "SCAR-20"		-- Weapon name (Shown on HUD)	
SWEP.Slot = 3
SWEP.SlotPos = 10
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_SCAR20.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.IronInSound = Sound("TFA_CSGO_SCAR20.Zoom") --Sound to play when ironsighting in?  nil for default
SWEP.IronOutSound = Sound("TFA_CSGO_SCAR20.Zoom") --Sound to play when ironsighting out?  nil for default
...
SWEP.IronSightsMoveSpeed  = 120/260*0.8 --Multiply the player's movespeed by this when sighting.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_snip_scar20.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_csgo/w_scar20.mdl" -- Weapon world model path
...
--SWEP.Secondary.ScopeZoom = 90 / 40
SWEP.Secondary.IronFOV			= 30					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.

SWEP.IronSightsPos = Vector(-5.15, -8.252, 1.20)
SWEP.IronSightsAng = Vector(-2.5, 0.9, -0.704)
SWEP.ScopeOverlayTransforms = {15, -15}
...
SWEP.BlowbackVector = Vector(-0.04,-2.5,-0.05) --Vector to move bone <or root> relative to bone <or view> orientation.
SWEP.BlowbackCurrentRoot = 0 --Amount of blowback currently, for root
SWEP.BlowbackCurrent = 0 --Amount of blowback currently, for bones
SWEP.BlowbackBoneMods = {
	["v_weapon.SCAR20_Bolt"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -0.2), angle = Angle(0, 0, 0) }
}
...
SWEP.MuzzleFlashEffect = "tfa_csgo_muzzle_huntingrifle"


SWEP.TracerParticleName = "weapon_tracers_rifle"
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_snip_scar20_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
...
SWEP.RTCode = function( self, rt, scrw, scrh )
	...
	if AngPos then
		...
		ang:RotateAroundAxis(ang:Right(),92.06)
		ang:RotateAroundAxis(ang:Forward(), 0)
		ang:RotateAroundAxis(ang:Up(), -0.02)

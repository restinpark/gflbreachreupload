...
SWEP.PrintName				= "M4A1-S"		-- Weapon name (Shown on HUD)	
SWEP.Slot = 3
SWEP.SlotPos = 10
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_M4A1.2")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("TFA_CSGO_M4A1.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_rif_m4a1_s.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_csgo/w_m4a1.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-5.421, -4, 0.065)
SWEP.IronSightsAng = Vector(1.17, -0.11, -0.75)
...
SWEP.StatusLengthOverride = {
	[ACT_VM_RELOAD] = 41 / 30,
	[ACT_VM_ATTACH_SILENCER] = 112 / 30,
	[ACT_VM_DETACH_SILENCER] = 118 / 30,
}
...
SWEP.MuzzleFlashEffectSilenced = "tfa_csgo_muzzle_assaultrifle_silenced"
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{ time = 18 / 30, type = "lua", value = function(wep,vm) wep:DropMag() end, client = true, server = true },
	}
}

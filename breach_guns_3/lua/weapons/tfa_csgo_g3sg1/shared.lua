SWEP.Gun					= ("tfa_csgo_g3sg1") --Make sure this is unique.  Specically, your folder name.  
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_CSGO_G3SG1.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.IronInSound = Sound("TFA_CSGO_Default.Zoom") --Sound to play when ironsighting in?  nil for default
SWEP.IronOutSound = Sound("TFA_CSGO_Default.Zoom") --Sound to play when ironsighting out?  nil for default
...
SWEP.ViewModel			= "models/weapons/tfa_csgo/c_snip_g3sg1.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-4.70, -3.035, 1.07)
SWEP.IronSightsAng = Vector(-0.3, 0.3, 0.703)
SWEP.ScopeOverlayTransforms = {-10, 10}
...
SWEP.BlowbackVector = Vector(0,-2.5,0.05) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.MagModel = Model("models/weapons/tfa_csgo/w_snip_g3sg1_mag.mdl")
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ time = 45 / 30, type = "lua", value = function(wep,vm) wep:DropMag() end, client = true, server = true },
	}
...
SWEP.RTCode = function( self, rt, scrw, scrh )
	...
	local pos = vm:GetAttachment(3).Pos - owoff
	...
	if AngPos then
		...
		ang:RotateAroundAxis(ang:Right(),90.3)
		ang:RotateAroundAxis(ang:Forward(), 0)
		ang:RotateAroundAxis(ang:Up(), -0.03)

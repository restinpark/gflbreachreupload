...
SWEP.PrintName = "SCP-1360"
SWEP.Author = "Kilburn, robotboy655, MaxOfS2D & Tenrys, chan_man1"
SWEP.Purpose = "Use the tools within you hands to open low level keycard access areas. Also deal signifigant damage to enemies with your combat expertise."
...
function SWEP:DealDamage()
	...
	if ( SERVER && IsValid( tr.Entity ) && ( tr.Entity:IsNPC() || tr.Entity:IsPlayer() || tr.Entity:Health() > 0 ) ) then
		...
		elseif ( anim == "fists_uppercut" ) then
			...
			dmginfo:SetDamage( math.random( 70, 80 ) )
		end

...
function EFFECT:Render()
	...
	ParticleEffect( "faton_tracer", endPos, Angle( 0, 0, 0 ), self.Entity )
	
	render.SetMaterial( self.Halo )
	render.DrawSprite( endPos, 18, 18, Color( 85, 255, 0, 0 ) )

	render.SetMaterial( self.Trace )
	render.DrawBeam( startPos, endPos, 64, 0, 1, Color( 85, 255, 0, 0 ) )

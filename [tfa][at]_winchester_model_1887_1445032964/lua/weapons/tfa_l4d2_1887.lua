...
SWEP.PrintName			= "M1887"		-- Weapon name (Shown on HUD)
...
SWEP.Weight				= 90			-- This controls how "good" the weapon is for autopickup.
SWEP.Type				= "Shotgun"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_L4D2.1887.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.SpreadMultiplierMax = 24 --How far the spread can expand when you shoot. Example val: 2.5
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_l4d2/c_1887.mdl" --Viewmodel path
...
SWEP.Bodygroups_V = {}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_l4d2/w_1887.mdl" -- Weapon world model path
SWEP.Bodygroups_W = {}
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(9, -10, -2)
SWEP.RunSightsAng = Vector(-5.25, 60, -12.5)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.445, 0, 2.635)
SWEP.IronSightsAng = Vector(-0.267, 0.006, 0)
...
SWEP.LuaShellEjectDelay = 12 / 30 --The delay to actually eject things
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 6 / 30, type = "sound", value = Sound("TFA_L4D2.1887.PumpForward")},
		{time = 11 / 30, type = "sound", value = Sound("TFA_L4D2.1887.PumpBack")},
	},
	[ACT_VM_DEPLOY] = {
		{time = 0, type = "sound", value = Sound("TFA_L4D2.1887.PumpForward")},
		{time = 14 / 30, type = "sound", value = Sound("TFA_L4D2.1887.PumpBack")},
	},
	[ACT_VM_PRIMARYATTACK] = {
		{time = 9 / 30, type = "sound", value = Sound("TFA_L4D2.1887.PumpForward")},
		{time = 15 / 30, type = "sound", value = Sound("TFA_L4D2.1887.PumpBack")},
	},
	[ACT_SHOTGUN_RELOAD_START] = {
		{time = 0, type = "sound", value = Sound("TFA_L4D2.1887.PumpForward")},
	},
	[ACT_VM_RELOAD] = {
		{time = 5 / 30, type = "sound", value = Sound("TFA_L4D2.1887.LoadShell")},
	},
	[ACT_SHOTGUN_RELOAD_FINISH] = {
		{time = 10 / 30, type = "sound", value = Sound("TFA_L4D2.1887.PumpBack")},
	},
...
SWEP.Attachments = {
	[1] = {atts = {"l4d2_1887_short"}},
	[2] = {atts = {"sg_frag", "sg_slug"}},
	[3] = {atts = {"l4d2_1887_shells"}},
}

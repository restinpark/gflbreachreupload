...
ATTACHMENT.Icon = "entities/hardlight_solar.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"

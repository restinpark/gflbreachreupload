...
SWEP.Category						= "KF2RR - Firebug" 								-- The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer 					= "TWI" 										-- Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.Purpose						= "A classic in any generation. If in doubt, simply burn everything down." 											-- Purpose Tooltip
SWEP.Instructions					= "Fire mode shoots flame. That's it." 											-- Instructions Tooltip
...
SWEP.Slot = 3
SWEP.SlotPos = 10
SWEP.ItemType = WEAPON_GUN or 6											-- Position in the slot
...
SWEP.Primary.DamageType 			= DMG_NEVERGIB 										-- See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.  Leave nil to autodetect.  DMG_AIRBOAT opens doors.
...
SWEP.SprintBobMult=4 -- More is more bobbing, proportionally.  This is multiplication, not addition.  You want to make this > 1 probably for sprinting.
SWEP.IronBobMult= 0.2--is more bobbing, proportionally.  This is multiplication, not addition.  You want to make this < 1 for sighting, 0 to outright disable.
...
SWEP.VMPos 							= Vector(4.8, 5, -3)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(8.2, -15.6, -9) 							-- Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng 					= Vector(25,80,0) 					-- Change this, using SWEP Creation Kit preferably
...
--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(10, 0.0, -1)
...
function SWEP:ShootBullet()
	...
	bul.Num = 1
	bul.Damage = self.Primary.Damage * ( 1000 / self.Primary.RPM )
	bul.Distance = self.Primary.Range
	bul.Tracer = 0
	bul.Callback = cb

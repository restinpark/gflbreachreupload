...
SWEP.Purpose = "Tuer Discrètement ."
...
SWEP.Category = "Razzer"
SWEP.DrawAmmo = false
SWEP.DrawCrosshair = false
SWEP.PrintName = "The Hidden Blade"
...
if trace.HitPos:Distance(self.Owner:GetShootPos()) <= 100 then
	...
	bullet.Damage = 60
		...
		self.Weapon:EmitSound("thehiddenbladehit1.wav")
		self.Weapon:EmitSound("thehiddenbladehit2.wav")
else
	self.Weapon:EmitSound("thehiddenblademiss1.wav")
	self.Weapon:EmitSound("thehiddenblademiss2.wav")
	self.Weapon:SendWeaponAnim(ACT_VM_MISSCENTER)
self.Owner:SetAnimation( PLAYER_ATTACK1 )
end

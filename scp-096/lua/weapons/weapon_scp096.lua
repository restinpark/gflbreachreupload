...
SWEP.Author					= "Aurora"
SWEP.Instructions			= "If people look at you, you can attack them, rip through doors with right click."
...
function SWEP:PrimaryAttack()
  ...
  timer.Simple( 0.15, function()
      ...
      if SERVER and IsValid( tr.Entity ) then
        if tr.Entity:IsPlayer() and (tr.Entity:Team() == TEAM_SCP or tr.Entity:Team() == TEAM_SPEC) then return end

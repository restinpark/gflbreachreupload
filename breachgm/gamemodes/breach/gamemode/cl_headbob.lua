...
function HeadBob(pl, pos, ang, fov)
	...
	if IsValid(pl:GetActiveWeapon()) and (pl:GetActiveWeapon().Base == "breachbase" or pl:GetActiveWeapon().Base == "tfa_gun_base" or pl:GetActiveWeapon().Base == "tfa_csgo_base" or pl:GetActiveWeapon().Base == "tfa_3dcsgo_base") then return end
	if IsValid(pl:GetActiveWeapon()) and string.match(pl:GetActiveWeapon():GetClass(), "tfa") then return end

...
function ENT:PhysicsCollide(data,phy)
	...
	util.BlastDamage(self.Entity:GetOwner(),self.Entity:GetOwner(),data.HitPos,1,0)
	// if 
		// ( data.HitEntity:IsValid() && data.HitEntity:IsPlayer() ) then data.HitEntity:TakeDamage( 0, self.Owner ) 
	// end

...
SWEP.Category				= "SCP Object" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "SCP-011's Gun"		-- Weapon name (Shown on HUD)
SWEP.Purpose = "Yes, I fucking know muskets can't hold 3 shots."
...
--Firing related
SWEP.Primary.Sound 			= Sound("weapons/awoi/musket_1_fire.wav")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/esw/v_m1777.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/esw/w_m1777.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-7.881, -7.237, 5.828)
SWEP.IronSightsAng = Vector(0.56, 0, 0)
SWEP.SightsPos = Vector(-7.881, -7.237, 5.828)
SWEP.SightsAng = Vector(0.56, 0, 0)
...
SWEP.MuzzleFlashEffect = "effect_awoi_smoke" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ ['time'] = 0, ['type'] = "sound", ['value'] = "m1777.reload" }
	}
}

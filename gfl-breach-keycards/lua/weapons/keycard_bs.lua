...
if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("models/scp/keycardbs/keycardu")
...
SWEP.ViewModel		= "models/weapons/c_keycardbs.mdl"
SWEP.WorldModel		= "models/props/sl/keycardbs.mdl"
SWEP.PrintName		= "Scientist Keycard"
SWEP.Slot = 0
SWEP.SlotPos = 5

...
if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("models/scp/keycardj/keycardu")
...
SWEP.ViewModel		= "models/weapons/c_keycardj.mdl"
SWEP.WorldModel		= "models/props/sl/keycardj.mdl"
SWEP.PrintName		= "Janitor's Keycard"
SWEP.Slot = 0
SWEP.SlotPos = 5
